 ...
 * @author Lenovo
 */
public class ProgramInterface extends javax.swing.JFrame {

    //Database.patients.add(new Patient()); to patient
    JFrame frame = new JFrame();
    String kullaniciAd = "mertAgcakoyun";
    String sifre = "1998";
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(altPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Authorized yetkili = new Authorized();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProgramInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProgramInterface().setVisible(true);
            }
        });
    }
